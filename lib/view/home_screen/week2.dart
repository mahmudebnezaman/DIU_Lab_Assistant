...
class _WeekTwoState extends State<WeekTwo> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  10.heightBox,
                  widget.data['lab_report2'] == '' ? Column(
                    children: [
                  ...
                  : Column(
                    ...
                    _launchURL(widget.data['lab_report2']);
                  }),
                   10.heightBox,
                  Column(
                    children: [
                      ...
                      myButton(
                        buttonSize: 20.0,
                        color: widget.data['week2_attendance'] == '2' ? Colors.lightGreenAccent : Colors.redAccent,
                        onPress: widget.data['week2_attendance'] == '2' ? 
                          (){
                            controller.editStudentAttendance(widget.semesteID, widget.courseID, widget.data.id,'week2_attendance', '0');
                            VxToast.show(context, msg: 'The student was absent');
                            Get.back();
                          } : 
                          (){
                            controller.editStudentAttendance(widget.semesteID, widget.courseID, widget.data.id,'week2_attendance', '2');
                            VxToast.show(context, msg: 'The student was present');
                            Get.back();
                          },
                        textColor: highEmphasis,
                        title: widget.data['week2_attendance'] == '2' ? 'Present' : 'Absent'
                      ),
                    ],
  ...
  Future uploadFile() async{
    ...
    final destination = 'week2/$fileName';
